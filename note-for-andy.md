...
# task working on
 ...
 - display on OLED
    ...
    - ~~set an alarm on the display~~
    - display two graph: current & drop count(may not do)
 ...
 - auto system
    ...
    - ~~set an alarm on web ~~
    - set an alarm on the board (wait for buzzer)
 - other/overall
...
U8g2
 ...
 - set up maybe a different in esp32
...
# result for test_i2c
the code is here:
https://linuxhint.com/scan-i2c-address-esp32-arduino-ide/
